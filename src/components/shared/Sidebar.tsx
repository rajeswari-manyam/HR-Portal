...
//   return (
//     <aside className={`relative flex flex-col bg-white border-r border-slate-100 h-screen transition-all duration-300 ${collapsed ? 'w-16' : 'w-64'} flex-shrink-0`}>
//       {/* Logo */}
...
//               <p className="text-xs text-slate-400 truncate capitalize">{user?.role === 'hr' ? 'HR Manager' : 'Employee'}</p>
//             </div>
//             <button onClick={handleLogout} className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-red-50 text-slate-400 hover:text-red-500 transition-colors" title="Logout">
//               <LogOut size={15} />
//             </button>
//           </div>
//         ) : (
//           <button onClick={handleLogout} className="sidebar-link justify-center px-0 w-full" title="Logout">
//             <LogOut size={18} />
//           </button>
//         )}
//       </div>
